...
import fr.utbm.lo52.messaging.model.network.ContentNetwork;
import fr.utbm.lo52.messaging.model.network.PacketNetwork;
...
public class NetworkService extends Service {
	...
	public static Hashtable<Integer, Conversation> getListConversations() {
		return (Hashtable<Integer, fr.utbm.lo52.messaging.model.Conversation>) listConversations.clone();
	}
	...
	public static boolean doesConversationExist(ArrayList<Integer> userIds) {
		...
		while (it.hasNext() && !exists) {
			Map.Entry pairs = (Map.Entry)it.next();
			Conversation c = (fr.utbm.lo52.messaging.model.Conversation) pairs.getValue();
